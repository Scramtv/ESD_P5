...
With Brick
     ...
     .Component "connector" 
     .Material "Gold" 
     .Xrange "-12.7/2", "12.7/2" 
     .Yrange "-12.7/2", "12.7/2" 
     .Zrange "0", "1.7" 
     .Create
End With
...
With Cylinder 
     ...
     .Axis "z" 
     .Zrange "0", "1.7" 
     .Xcenter "(12.7/2)-(2.4/2)-0.8" 
     .Ycenter "12.7/2-0.8-2.4/2" 
     .Segments "0" 
     .Create 
End With
...
'[VERSION]2025.0|34.0.1|20240830[/VERSION]
WCS.MoveWCS "local", "-1", "-Lp/2-9", "0.0"

'@ define brick: component1_1:Union line
...
'[VERSION]2025.0|34.0.1|20240830[/VERSION]
WCS.MoveWCS "local", "62/2", "0.0", "0.0"
...
'[VERSION]2025.0|34.0.1|20240830[/VERSION]
WCS.MoveWCS "local", "0", "-2", "0.0"

'@ define brick: component1_1:connector line
...
'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Pick.PickFaceFromId "component1:substrate", "6"

'@ pick face

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Pick.PickFaceFromId "component1:groundplane", "10"
...
'@ boolean add shapes: component1:groundplane, component1_1:groundplane

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1:groundplane", "component1_1:groundplane"

'@ boolean add shapes: component1:groundplane, component1_1:solid1_1

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1:groundplane", "component1_1:solid1_1"

'@ boolean add shapes: component1:substrate, component1_1:solid1

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1:substrate", "component1_1:solid1"

'@ boolean add shapes: component1:substrate, component1_1:substrate

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1:substrate", "component1_1:substrate"

'@ boolean add shapes: component1:patch, component1_1:Union line

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1:patch", "component1_1:Union line"

'@ boolean add shapes: component1_1:connector line, component1_1:patch

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1_1:connector line", "component1_1:patch"

'@ boolean add shapes: component1:patch, component1_1:connector line

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Solid.Add "component1:patch", "component1_1:connector line"
...
'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Pick.PickFaceFromId "component1:patch", "30"
...
'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Pick.PickFaceFromId "component1:substrate", "15"

'@ pick face

'[VERSION]2025.0|34.0.1|20240830[/VERSION]
Pick.PickFaceFromId "component1:groundplane", "23"
...
'[VERSION]2025.5|34.0.1|20250530[/VERSION]
Pick.PickFaceFromId "component1:groundplane", "5"
...
'@ boolean add shapes: component1_1:solid1, component1:substrate

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
Solid.Add "component1_1:solid1", "component1:substrate"

'@ boolean add shapes: component1_1:solid1_1, component1:groundplane

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
Solid.Add "component1_1:solid1_1", "component1:groundplane"
...
'[VERSION]2025.5|34.0.1|20250530[/VERSION]
Pick.PickEdgeFromId "component1:patch", "130", "88"

'@ pick edge

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
Pick.PickEdgeFromId "component1_1:solid1", "49", "27"
...
'@ define farfield monitor: farfield (f=2.35)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.35)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.35" 
     .ExportFarfieldSource "False" 
     ...
     .SetSubvolume "-30", "90", "-33.95", "26.95", "-1.645", "10.2102" 
...
'@ define farfield monitor: farfield (f=2.34)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.34)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.34" 
     .ExportFarfieldSource "False" 
...
'@ define monitor: e-field (f=2.3572)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "e-field (f=2.3572)" 
     .Domain "Frequency" 
     .FieldType "Efield" 
     .MonitorValue "2.3572" 
     .UseSubvolume "False" 
...
'@ delete monitor: e-field (f=2.3572)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
Monitor.Delete "e-field (f=2.3572)"

'@ define farfield monitor: farfield (f=2.372)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.372)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.372" 
     .ExportFarfieldSource "False" 
...
'@ delete monitor: e-field (f=2.36)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Delete "e-field (f=2.36)" 
End With
...
With Monitor 
     ...
     .UseSubvolume "False" 
     .Coordinates "Structure" 
     .SetSubvolume "-30", "90", "-33.950000000000003", "26.949999999999999", "-1.645", "10.2102" 
     .SetSubvolumeOffset "10", "10", "10", "10", "10", "10" 
     .SetSubvolumeInflateWithOffset "False" 
     .SetSubvolumeOffsetType "FractionOfWavelength" 
     .EnableNearfieldCalculation "True" 
...
'@ delete monitor: farfield (f=2.34)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Delete "farfield (f=2.34)" 
End With
...
'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Delete "farfield (f=2.45)" 
End With

'@ define farfield monitor: farfield (f=2.39)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.39)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.39" 
     .ExportFarfieldSource "False" 
