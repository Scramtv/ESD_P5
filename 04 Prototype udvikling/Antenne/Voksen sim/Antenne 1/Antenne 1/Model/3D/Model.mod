...
'@ define farfield monitor: farfield (f=2.375)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.375)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.375" 
     .ExportFarfieldSource "False" 
...
'@ define farfield monitor: farfield (f=2.385)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.385)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.385" 
     .ExportFarfieldSource "False" 
...
'@ define farfield monitor: farfield (f=2.37)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=2.37)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "2.37" 
     .ExportFarfieldSource "False" 
