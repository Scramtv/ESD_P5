...
<MetaResultFile version="20211011" creator="Solver">
  ...
  <AuxResultFile filename="TLMMesh_Connectivity.axg" add_to_tree="1" default="0" tree_type="main"/>
  <FieldFreeNodes/>
  ...
  <PPResults>
    <ResultInfo filename="TLMMesh_Connectivity_discrete.rex" type="DiscreteSurface:On"/>
  </PPResults>
  <AutoScale>
