...
<MetaResultFile version="20211011" creator="TLM">
  <MetaGeometryFile filename="TLM.gex" lod="1"/>
  <SimulationProperties fieldname="&lt;name missing&gt;" frequency="0" encoded_unit="&amp;U" fieldtype="Discrete View" fieldscaling="NONE" dB_Amplitude="0"/>
  ...
  <SupplementalMesh/>
  <AuxGeometryFile filename="TLM.axg"/>
  <AuxResultFile/>
  <FieldFreeNodes/>
