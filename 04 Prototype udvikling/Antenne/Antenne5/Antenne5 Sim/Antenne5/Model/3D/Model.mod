...
'@ delete monitor: e-field (f=2.35)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Delete "e-field (f=2.35)" 
End With
...
'@ define farfield monitor: farfield (f=3572)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=3572)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "3572" 
     .ExportFarfieldSource "False" 
...
'@ delete monitor: farfield (f=2.3)

'[VERSION]2025.5|34.0.1|20250530[/VERSION]
With Monitor 
     .Delete "farfield (f=2.3)" 
End With
