...
I1 = real(x2500MHz_RX1.Ch1)*0.625;
Q1 = imag(x2500MHz_RX1.Ch1)*0.625;
...
I2 = real(x2500MHz_RX2.Ch2)*0.625;
Q2 = imag(x2500MHz_RX2.Ch2)*0.625;
...
I1 = real(xNoise.Ch1)*0.625;
Q1 = imag(xNoise.Ch1)*0.625;
...
I2 = real(xNoise.Ch2)*0.625;
Q2 = imag(xNoise.Ch2)*0.625;
