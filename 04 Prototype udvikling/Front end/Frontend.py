...
class Frontend(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_pub_sink_0_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://*:5556', 100, False, (-1), '', True, True)
        ...
        self.soapy_bladerf_source_0_0 = soapy.source(dev, "fc32", 1, 'bladrf=0,channel=1',
        ...
        self.soapy_bladerf_source_0 = soapy.source(dev, "fc32", 1, 'bladrf=0,channel=0',
                                  stream_args, tune_args, settings)
        ...
        self.connect((self.soapy_bladerf_source_0_0, 0), (self.zeromq_pub_sink_0_0, 0))
